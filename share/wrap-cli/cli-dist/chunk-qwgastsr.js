...
function SessionInfo({ onDone }) {
  ...
  if (!remoteSessionUrl) {
    return /* @__PURE__ */ jsx_runtime.jsxs(Pane, {
      children: [
...
`).filter((line) => line.length > 0);
  ...
  return /* @__PURE__ */ jsx_runtime.jsxs(Pane, {
    children: [
      ...
      isLoading ? /* @__PURE__ */ jsx_runtime.jsx(ThemedText, {
        dimColor: true,
...
var import_react, jsx_runtime, call = async (onDone) => {
  return /* @__PURE__ */ jsx_runtime.jsx(SessionInfo, {
    onDone
  });
};
...
//# debugId=BB7617C7A55FEC7464756E2164756E21
//# sourceMappingURL=chunk-qwgastsr.js.map

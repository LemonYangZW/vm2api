...
function RemoteEnvironmentDialog({ onDone }) {
  ...
  if (loadingState === "loading") {
    return /* @__PURE__ */ jsx_runtime.jsx(Dialog, {
      ...
      onCancel: onDone,
      hideInputGuide: true,
      children: /* @__PURE__ */ jsx_runtime.jsx(LoadingState, {
  ...
  if (environments.length === 1) {
    return /* @__PURE__ */ jsx_runtime.jsx(SingleEnvironmentContent, {
      environment: selectedEnvironment,
      onDone
    });
  }
  return /* @__PURE__ */ jsx_runtime.jsx(MultipleEnvironmentsContent, {
    environments,
    selectedEnvironment,
    selectedEnvironmentSource,
    loadingState,
...
function SingleEnvironmentContent({
  ...
  return /* @__PURE__ */ jsx_runtime.jsx(Dialog, {
    ...
    subtitle: SETUP_HINT,
    onCancel: onDone,
    children: /* @__PURE__ */ jsx_runtime.jsx(EnvironmentLabel, {
      environment
    })
  });
}
function MultipleEnvironmentsContent({
  ...
  const subtitle = /* @__PURE__ */ jsx_runtime.jsxs(ThemedText, {
    children: [
      "Currently using: ",
      /* @__PURE__ */ jsx_runtime.jsx(ThemedText, {
        bold: true,
  ...
  return /* @__PURE__ */ jsx_runtime.jsxs(Dialog, {
    ...
    children: [
      ...
      loadingState === "updating" ? /* @__PURE__ */ jsx_runtime.jsx(LoadingState, {
        message: "Updating\u2026"
...
var import_react, jsx_runtime, DIALOG_TITLE = "Select Remote Environment", SETUP_HINT = `Configure environments at: https://claude.ai/code`;
...
async function call(onDone) {
  return /* @__PURE__ */ jsx_runtime2.jsx(RemoteEnvironmentDialog, {
    onDone
  });
}
var jsx_runtime2;
...
//# debugId=D56DE98914A5FF9864756E2164756E21
//# sourceMappingURL=chunk-tktc7qb4.js.map

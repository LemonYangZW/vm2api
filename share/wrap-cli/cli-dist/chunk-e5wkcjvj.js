...
var import_client, import_property_provider, resolveCredentialSource = (credentialSource, profileName, logger) => {
  const sourceProvidersMap = {
    EcsContainer: async (options) => {
      ...
      const { fromContainerMetadata } = await import("./chunk-g72h52y6.js");
    ...
    Ec2InstanceMetadata: async (options) => {
      ...
      const { fromInstanceMetadata } = await import("./chunk-g72h52y6.js");
      return async () => fromInstanceMetadata(options)().then(setNamedProvider);
    },
    Environment: async (options) => {
      logger?.debug("@aws-sdk/credential-provider-ini - credential_source is Environment");
      const { fromEnv } = await import("./chunk-9skwrnd2.js");
...
var import_client2, import_property_provider2, import_shared_ini_file_loader, isAssumeRoleProfile = (arg, { profile = "default", logger } = {}) => {
  ...
  if (!options.roleAssumer) {
    const { getDefaultRoleAssumer } = await import("./chunk-5anta954.js").then((m)=>__toESM(m.default,1));
...
var init_LoginCredentialsFetcher = __esm(() => {
  ...
  LoginCredentialsFetcher = class LoginCredentialsFetcher {
    ...
    async refresh(token) {
      const { SigninClient, CreateOAuth2TokenCommand } = await import("./chunk-mv5pac8a.js").then((m)=>__toESM(m.default,1));
...
var import_client5, isProcessProfile = (arg) => Boolean(arg) && typeof arg === "object" && typeof arg.credential_process === "string", resolveProcessCredentials = async (options, profile) => import("./chunk-73v2m4zh.js").then(({ fromProcess }) => fromProcess({
  ...options,
  profile
...
var import_client6, resolveSsoCredentials = async (profile, profileData, options = {}, callerClientConfig) => {
  const { fromSSO } = await import("./chunk-srr63t24.js");
  return fromSSO({
    profile,
...
//# debugId=E8D32EF937A0E14464756E2164756E21
//# sourceMappingURL=chunk-e5wkcjvj.js.map

...
function ToggleTagAndClose({
  ...
  if (showConfirm && sessionId) {
    return /* @__PURE__ */ jsx_runtime.jsx(ConfirmRemoveTag, {
...
async function call(onDone, _context, args) {
  ...
  if (COMMON_INFO_ARGS.includes(args) || COMMON_HELP_ARGS.includes(args)) {
    return /* @__PURE__ */ jsx_runtime.jsx(ShowHelp, {
      onDone
    });
  }
  if (!args) {
  ...
  return /* @__PURE__ */ jsx_runtime.jsx(ToggleTagAndClose, {
    tagName: args,
    onDone
  });
}
...
//# debugId=16C8D2546D0B025864756E2164756E21
//# sourceMappingURL=chunk-hrxqj6bz.js.map

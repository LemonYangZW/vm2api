...
function renderInputGuide(exitState) {
  ...
  return /* @__PURE__ */ jsx_runtime.jsxs(Byline, {
    children: [
...
function WorkflowMultiselectDialog({ onSubmit, defaultSelections }) {
  ...
  return /* @__PURE__ */ jsx_runtime.jsxs(Dialog, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx_runtime.jsx(SelectMulti, {
      ...
      showError && /* @__PURE__ */ jsx_runtime.jsx(ThemedBox_default, {
...
var import_react, jsx_runtime, WORKFLOWS;
    ...
    children: [
      /* @__PURE__ */ jsx_runtime2.jsxs(ThemedBox_default, {
        ...
        children: [
          ...
          existingApiKey && /* @__PURE__ */ jsx_runtime2.jsx(ThemedBox_default, {
            marginBottom: 1,
          ...
          onCreateOAuthToken && /* @__PURE__ */ jsx_runtime2.jsx(ThemedBox_default, {
            marginBottom: 1,
            children: /* @__PURE__ */ jsx_runtime2.jsxs(ThemedText, {
              children: [
          ...
          selectedOption === "new" && /* @__PURE__ */ jsx_runtime2.jsx(TextInput, {
    ...
    children: [
      /* @__PURE__ */ jsx_runtime3.jsxs(ThemedBox_default, {
        ...
        children: [
          ...
          !useExistingSecret && /* @__PURE__ */ jsx_runtime3.jsxs(jsx_runtime3.Fragment, {
            children: [
              /* @__PURE__ */ jsx_runtime3.jsx(ThemedBox_default, {
                marginBottom: 1,
                children: /* @__PURE__ */ jsx_runtime3.jsx(ThemedText, {
              ...
              /* @__PURE__ */ jsx_runtime3.jsx(TextInput, {
                value: secretName,
...
var import_react3, jsx_runtime3;
...
function CheckGitHubStep() {
  return /* @__PURE__ */ jsx_runtime4.jsx(ThemedText, {
    ...
    children: [
      /* @__PURE__ */ jsx_runtime5.jsxs(ThemedBox_default, {
        ...
        children: [
          ...
          currentRepo && /* @__PURE__ */ jsx_runtime5.jsx(ThemedBox_default, {
            marginBottom: 1,
          ...
          (!useCurrentRepo || !currentRepo) && /* @__PURE__ */ jsx_runtime5.jsx(ThemedBox_default, {
            marginLeft: 2,
            marginBottom: 1,
            children: /* @__PURE__ */ jsx_runtime5.jsx(TextInput, {
              value: repoUrl,
              onChange: (value) => {
      ...
      showEmptyError && /* @__PURE__ */ jsx_runtime5.jsx(ThemedBox_default, {
        marginLeft: 3,
        marginBottom: 1,
...
var import_react4, jsx_runtime5;
...
function ErrorStep({ error, errorReason, errorInstructions }) {
    ...
    children: [
      /* @__PURE__ */ jsx_runtime7.jsxs(ThemedBox_default, {
        ...
        children: [
          ...
          errorReason && /* @__PURE__ */ jsx_runtime7.jsx(ThemedBox_default, {
            marginTop: 1,
          ...
          errorInstructions && errorInstructions.length > 0 && /* @__PURE__ */ jsx_runtime7.jsxs(ThemedBox_default, {
            flexDirection: "column",
            marginTop: 1,
            children: [
              ...
              errorInstructions.map((instruction, index) => /* @__PURE__ */ jsx_runtime7.jsxs(ThemedBox_default, {
                marginLeft: 2,
                children: [
                  /* @__PURE__ */ jsx_runtime7.jsx(ThemedText, {
                    dimColor: true,
...
function ExistingWorkflowStep({ repoName, onSelectAction }) {
  const options = [
    {
  ...
  return /* @__PURE__ */ jsx_runtime8.jsxs(ThemedBox_default, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx_runtime8.jsx(ThemedBox_default, {
        flexDirection: "column",
        children: /* @__PURE__ */ jsx_runtime8.jsx(Select, {
          options,
...
function InstallAppStep({ repoUrl, onSubmit }) {
  ...
  return /* @__PURE__ */ jsx_runtime9.jsxs(ThemedBox_default, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx_runtime9.jsx(ThemedBox_default, {
        marginBottom: 1,
        children: /* @__PURE__ */ jsx_runtime9.jsxs(ThemedText, {
          children: [
...
function OAuthFlowStep({ onSuccess, onCancel }) {
    ...
    switch (oauthStatus.state) {
      ...
      case "waiting_for_login":
        return /* @__PURE__ */ jsx_runtime10.jsxs(ThemedBox_default, {
          ...
          gap: 1,
          children: [
            !showPastePrompt && /* @__PURE__ */ jsx_runtime10.jsxs(ThemedBox_default, {
              children: [
                /* @__PURE__ */ jsx_runtime10.jsx(Spinner, {}),
                /* @__PURE__ */ jsx_runtime10.jsx(ThemedText, {
      ...
      case "error":
        return /* @__PURE__ */ jsx_runtime10.jsxs(ThemedBox_default, {
          ...
          children: [
            ...
            oauthStatus.toRetry ? /* @__PURE__ */ jsx_runtime10.jsx(ThemedText, {
              dimColor: true,
  ...
  return /* @__PURE__ */ jsx_runtime10.jsxs(ThemedBox_default, {
    ...
    children: [
      oauthStatus.state === "starting" && /* @__PURE__ */ jsx_runtime10.jsxs(ThemedBox_default, {
        flexDirection: "column",
        gap: 1,
        paddingBottom: 1,
        children: [
      ...
      oauthStatus.state !== "success" && oauthStatus.state !== "starting" && oauthStatus.state !== "processing" && /* @__PURE__ */ jsx_runtime10.jsxs(ThemedBox_default, {
        flexDirection: "column",
        gap: 1,
        paddingBottom: 1,
        children: [
      ...
      oauthStatus.state === "waiting_for_login" && showPastePrompt && /* @__PURE__ */ jsx_runtime10.jsxs(ThemedBox_default, {
        flexDirection: "column",
        gap: 1,
        paddingBottom: 1,
        children: [
...
var import_react5, jsx_runtime10, PASTE_HERE_MSG = "Paste code here if prompted > ";
    ...
    children: [
      /* @__PURE__ */ jsx_runtime11.jsxs(ThemedBox_default, {
        ...
        children: [
          ...
          !skipWorkflow && /* @__PURE__ */ jsx_runtime11.jsx(ThemedText, {
            color: "success",
            children: "\u2713 GitHub Actions workflow created!"
          }),
          secretExists && useExistingSecret && /* @__PURE__ */ jsx_runtime11.jsx(ThemedBox_default, {
            marginTop: 1,
          ...
          skipWorkflow ? /* @__PURE__ */ jsx_runtime11.jsxs(jsx_runtime11.Fragment, {
            children: [
              /* @__PURE__ */ jsx_runtime11.jsx(ThemedText, {
...
function WarningsStep({ warnings, onContinue }) {
  ...
  return /* @__PURE__ */ jsx_runtime12.jsx(jsx_runtime12.Fragment, {
    children: /* @__PURE__ */ jsx_runtime12.jsxs(ThemedBox_default, {
      ...
      children: [
        ...
        warnings.map((warning, index) => /* @__PURE__ */ jsx_runtime12.jsxs(ThemedBox_default, {
          flexDirection: "column",
          marginBottom: 1,
          children: [
            /* @__PURE__ */ jsx_runtime12.jsx(ThemedText, {
            ...
            warning.instructions.length > 0 && /* @__PURE__ */ jsx_runtime12.jsx(ThemedBox_default, {
              flexDirection: "column",
              marginLeft: 2,
              marginTop: 1,
              children: warning.instructions.map((instruction, i) => /* @__PURE__ */ jsx_runtime12.jsxs(ThemedText, {
                dimColor: true,
                children: [
                  "\u2022 ",
                  instruction
...
For manual setup instructions, see: ${GITHUB_ACTION_SETUP_DOCS_URL}`);
  ...
  switch (state.step) {
    case "check-gh":
      return /* @__PURE__ */ jsx_runtime13.jsx(CheckGitHubStep, {});
    case "warnings":
      return /* @__PURE__ */ jsx_runtime13.jsx(WarningsStep, {
        warnings: state.warnings,
        onContinue: handleSubmit
      });
    case "choose-repo":
      return /* @__PURE__ */ jsx_runtime13.jsx(ChooseRepoStep, {
    ...
    case "install-app":
      return /* @__PURE__ */ jsx_runtime13.jsx(InstallAppStep, {
        repoUrl: state.selectedRepoName,
        onSubmit: handleSubmit
      });
    case "check-existing-workflow":
      return /* @__PURE__ */ jsx_runtime13.jsx(ExistingWorkflowStep, {
        repoName: state.selectedRepoName,
        onSelectAction: handleWorkflowAction
      });
    case "check-existing-secret":
      return /* @__PURE__ */ jsx_runtime13.jsx(CheckExistingSecretStep, {
    ...
    case "api-key":
      return /* @__PURE__ */ jsx_runtime13.jsx(ApiKeyStep, {
        existingApiKey,
    ...
    case "creating":
      return /* @__PURE__ */ jsx_runtime13.jsx(CreatingStep, {
    ...
    case "success":
      return /* @__PURE__ */ jsx_runtime13.jsx(ThemedBox_default, {
        tabIndex: 0,
        autoFocus: true,
        onKeyDown: handleDismissKeyDown,
        children: /* @__PURE__ */ jsx_runtime13.jsx(SuccessStep, {
          secretExists: state.secretExists,
          useExistingSecret: state.useExistingSecret,
          secretName: state.secretName,
          skipWorkflow: state.workflowAction === "skip"
    ...
    case "error":
      return /* @__PURE__ */ jsx_runtime13.jsx(ThemedBox_default, {
        ...
        autoFocus: true,
        onKeyDown: handleDismissKeyDown,
        children: /* @__PURE__ */ jsx_runtime13.jsx(ErrorStep, {
          error: state.error,
    ...
    case "select-workflows":
      return /* @__PURE__ */ jsx_runtime13.jsx(WorkflowMultiselectDialog, {
    ...
    case "oauth-flow":
      return /* @__PURE__ */ jsx_runtime13.jsx(OAuthFlowStep, {
...
async function call(onDone) {
  return /* @__PURE__ */ jsx_runtime13.jsx(InstallGitHubApp, {
    onDone
  });
}
var import_react6, jsx_runtime13, INITIAL_STATE;
...
//# debugId=E8EE04661DF54FA564756E2164756E21
//# sourceMappingURL=chunk-peyphzx1.js.map

...
async function selectEngine() {
  if (process.platform === "win32") {
    const { DetachedEngine: DetachedEngine2 } = await import("./chunk-k6q3741y.js");
    return new DetachedEngine2;
  }
  const { TmuxEngine } = await import("./chunk-hh6361ch.js");
  const tmux = new TmuxEngine;
  if (await tmux.available()) {
    return tmux;
  }
  const { DetachedEngine } = await import("./chunk-k6q3741y.js");
...
export { listLiveSessions, findSession, psHandler, logsHandler, attachHandler, killHandler, handleBgStart, init_bg };

//# debugId=5386AE84C830367B64756E2164756E21
//# sourceMappingURL=chunk-swv9nr00.js.map

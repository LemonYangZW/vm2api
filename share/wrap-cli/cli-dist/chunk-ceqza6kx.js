...
function assertValidUnixSocketPath(path) {
  if (process.platform === "win32")
    return;
  const byteLength = Buffer.byteLength(path, "utf8");
  if (byteLength > MAX_UNIX_SOCKET_PATH_LENGTH) {
    throw new Error(`[udsMessaging] socket path is ${byteLength} bytes (max ${MAX_UNIX_SOCKET_PATH_LENGTH}): ${path}`);
  }
}
...
var server = null, socketPath = null, onEnqueueCb = null, clients, inbox, nextId = 1, defaultSocketPath = null, authToken = null, capabilityFilePath = null, inboxBytes = 0, MAX_UDS_INBOX_ENTRIES = 1000, MAX_UDS_FRAME_BYTES, MAX_UDS_INBOX_BYTES, MAX_UDS_CLIENTS = 128, UDS_AUTH_TIMEOUT_MS = 2000, UDS_IDLE_TIMEOUT_MS = 30000, MAX_UNIX_SOCKET_PATH_LENGTH = 104;
...
export { getChunkBytes, attachUdsResponseReader, init_udsResponseReader, MAX_UDS_INBOX_ENTRIES, MAX_UDS_FRAME_BYTES, MAX_UDS_INBOX_BYTES, MAX_UDS_CLIENTS, UDS_AUTH_TIMEOUT_MS, UDS_IDLE_TIMEOUT_MS, MAX_UNIX_SOCKET_PATH_LENGTH, assertValidUnixSocketPath, getDefaultUdsSocketPath, getUdsMessagingSocketPath, formatUdsAddress, parseUdsTarget, readUdsCapabilityToken, setOnEnqueue, drainInbox, startUdsMessaging, stopUdsMessaging, sendUdsMessage, init_udsMessaging };

//# debugId=1940B71F4728FD5664756E2164756E21
//# sourceMappingURL=chunk-ceqza6kx.js.map

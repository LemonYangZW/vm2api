...
async function call(onDone) {
  ...
  if (settings.grove_enabled !== null) {
    return /* @__PURE__ */ jsx_runtime.jsx(PrivacySettingsDialog, {
      settings,
      domainExcluded: config?.domain_excluded,
      onDone: onDoneWithSettingsCheck
    });
  }
  return /* @__PURE__ */ jsx_runtime.jsx(GroveDialog, {
    showIfAlreadyViewed: true,
    onDone: onDoneWithDecision,
    location: "settings"
  });
}
var jsx_runtime, FALLBACK_MESSAGE = "Review and manage your privacy settings at https://claude.ai/settings/data-privacy-controls";
...
//# debugId=F56A8BB43E70955C64756E2164756E21
//# sourceMappingURL=chunk-gtkj1sqz.js.map

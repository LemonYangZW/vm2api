...
function MCPServerDesktopImportDialog({ servers, scope, onDone }) {
...
No servers were imported.`);
  ...
  return /* @__PURE__ */ jsx_runtime.jsxs(jsx_runtime.Fragment, {
    children: [
      /* @__PURE__ */ jsx_runtime.jsxs(Dialog, {
        ...
        hideInputGuide: true,
        children: [
          collisions.length > 0 && /* @__PURE__ */ jsx_runtime.jsx(ThemedText, {
            color: "warning",
...
async function mcpServeHandler({ debug, verbose }) {
  ...
  try {
    ...
    const { startMCPServer } = await import("./chunk-qx1artpv.js");
...
async function mcpAddFromDesktopHandler(options) {
  try {
    ...
    const { readClaudeDesktopMcpServers } = await import("./chunk-w9pb0ewq.js");
    const servers = await readClaudeDesktopMcpServers();
    if (Object.keys(servers).length === 0) {
      cliOk("No MCP servers found in Claude Desktop configuration or configuration file does not exist.");
    }
    const { unmount } = await root_default(/* @__PURE__ */ jsx_runtime2.jsx(AppStateProvider, {
      children: /* @__PURE__ */ jsx_runtime2.jsx(KeybindingSetup, {
        children: /* @__PURE__ */ jsx_runtime2.jsx(MCPServerDesktopImportDialog, {
          servers,
          scope,
          onDone: () => {
            unmount();
...
//# debugId=9CCD0C5BD3AF7C0764756E2164756E21
//# sourceMappingURL=chunk-199cgb6y.js.map

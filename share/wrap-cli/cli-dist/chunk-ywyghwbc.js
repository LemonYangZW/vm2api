...
function TrustDialog({ onDone, commands }) {
  ...
  const [pendingExitCode, setPendingExitCode] = import_react.default.useState(null);
  ...
  return /* @__PURE__ */ jsx_runtime.jsx(PermissionDialog, {
    ...
    children: /* @__PURE__ */ jsx_runtime.jsxs(ThemedBox_default, {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx_runtime.jsx(ThemedText, {
          children: "Is this a project you trust? (Your own code, a well-known open source project, or work from your team)."
        }),
        /* @__PURE__ */ jsx_runtime.jsx(ThemedText, {
          children: "Once trusted, Claude Code can read, edit, and run commands in this folder."
        }),
        /* @__PURE__ */ jsx_runtime.jsx(ThemedText, {
          dimColor: true,
...
//# debugId=A559055B612DCA0564756E2164756E21
//# sourceMappingURL=chunk-ywyghwbc.js.map

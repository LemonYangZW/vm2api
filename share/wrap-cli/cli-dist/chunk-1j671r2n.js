...
async function createBridgeSession({
  ...
  const { getClaudeAIOAuthTokens } = await import("./chunk-wxc2kf3z.js");
  const { getOrganizationUUID } = await import("./chunk-4teve7kp.js");
  const { getOauthConfig } = await import("./chunk-hgjqr0x2.js");
  const { getOAuthHeaders } = await import("./chunk-ftterwb0.js");
  const { parseGitHubRepository } = await import("./chunk-g0gc770r.js");
  const { getDefaultBranch } = await import("./chunk-1cjn800a.js");
  const { getMainLoopModel } = await import("./chunk-f87r04q5.js");
  const { default: axios } = await import("./chunk-v3x8tcc0.js");
  const { isSelfHostedBridge } = await import("./chunk-whd9c03f.js");
...
//# sourceMappingURL=chunk-1j671r2n.js.map

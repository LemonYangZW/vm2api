...
function ResumeTask({ onSelect, onCancel, isEmbedded = false }) {
  ...
  if (!hasCompletedTeleportErrorFlow) {
    return /* @__PURE__ */ jsx_runtime.jsx(TeleportError, {
      ...
      children: [
        /* @__PURE__ */ jsx_runtime.jsxs(ThemedText, {
          ...
          children: [
            ...
            currentRepo && /* @__PURE__ */ jsx_runtime.jsxs(ThemedText, {
              children: [
                " for ",
                currentRepo
              ]
    ...
    children: [
      /* @__PURE__ */ jsx_runtime.jsxs(ThemedText, {
        ...
        children: [
          ...
          showScrollPosition && /* @__PURE__ */ jsx_runtime.jsxs(ThemedText, {
            dimColor: true,
            children: [
              " ",
              "(",
...
function TeleportResumeWrapper({
    ...
    return /* @__PURE__ */ jsx_runtime2.jsxs(ThemedBox_default, {
      ...
      children: [
        /* @__PURE__ */ jsx_runtime2.jsxs(ThemedBox_default, {
          flexDirection: "row",
          children: [
            /* @__PURE__ */ jsx_runtime2.jsx(Spinner, {}),
  ...
  return /* @__PURE__ */ jsx_runtime2.jsx(ResumeTask, {
...
//# debugId=BED8223E3A83EBD864756E2164756E21
//# sourceMappingURL=chunk-8rgd8373.js.map

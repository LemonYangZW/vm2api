...
function BashModeProgress({ input, progress, verbose }) {
  return /* @__PURE__ */ jsx_runtime.jsxs(ThemedBox_default, {
    flexDirection: "column",
    marginTop: 1,
    children: [
      /* @__PURE__ */ jsx_runtime.jsx(UserBashInputMessage, {
        addMargin: false,
        param: { text: `<bash-input>${input}</bash-input>`, type: "text" }
      }),
      progress ? /* @__PURE__ */ jsx_runtime.jsx(ShellProgressMessage, {
...
async function processBashCommand(inputString, precedingInputBlocks, attachmentMessages, context, setToolJSX) {
  ...
  let jsx2;
  setToolJSX({
    jsx: /* @__PURE__ */ jsx2(BashModeProgress, {
      input: inputString,
      progress: null,
  ...
  try {
    ...
    const onProgress = (progress) => {
      setToolJSX({
        jsx: /* @__PURE__ */ jsx_runtime2.jsxs(jsx_runtime2.Fragment, {
          children: [
            /* @__PURE__ */ jsx2(BashModeProgress, {
              input: inputString,
...
//# debugId=35A8740F263C24B664756E2164756E21
//# sourceMappingURL=chunk-6rb9j5cp.js.map

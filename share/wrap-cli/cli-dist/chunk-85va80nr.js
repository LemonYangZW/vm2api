...
function SetupNotes({ messages }) {
  ...
  return /* @__PURE__ */ jsx_runtime.jsxs(ThemedBox_default, {
    ...
    children: [
      ...
      messages.map((message, index) => /* @__PURE__ */ jsx_runtime.jsx(ThemedBox_default, {
        marginLeft: 2,
        children: /* @__PURE__ */ jsx_runtime.jsxs(ThemedText, {
          dimColor: true,
          children: [
...
function Install({ onDone, force, target }) {
  ...
  return /* @__PURE__ */ jsx_runtime.jsxs(ThemedBox_default, {
    ...
    marginTop: 1,
    children: [
      state.type === "checking" && /* @__PURE__ */ jsx_runtime.jsx(ThemedText, {
        color: "claude",
        children: "Checking installation status..."
      }),
      state.type === "cleaning-npm" && /* @__PURE__ */ jsx_runtime.jsx(ThemedText, {
        color: "warning",
        children: "Cleaning up old npm installations..."
      }),
      state.type === "installing" && /* @__PURE__ */ jsx_runtime.jsxs(ThemedText, {
        color: "claude",
        children: [
      ...
      state.type === "setting-up" && /* @__PURE__ */ jsx_runtime.jsx(ThemedText, {
        color: "claude",
        children: "Setting up launcher and shell integration..."
      }),
      state.type === "set-up" && /* @__PURE__ */ jsx_runtime.jsx(SetupNotes, {
        messages: state.messages
      }),
      state.type === "success" && /* @__PURE__ */ jsx_runtime.jsxs(ThemedBox_default, {
        flexDirection: "column",
        gap: 1,
        children: [
          ...
          /* @__PURE__ */ jsx_runtime.jsxs(ThemedBox_default, {
            ...
            gap: 1,
            children: [
              state.version !== "current" && /* @__PURE__ */ jsx_runtime.jsxs(ThemedBox_default, {
                children: [
                  /* @__PURE__ */ jsx_runtime.jsx(ThemedText, {
                    dimColor: true,
                    children: "Version: "
          ...
          state.setupMessages && /* @__PURE__ */ jsx_runtime.jsx(SetupNotes, {
            messages: state.setupMessages
          })
        ]
      }),
      state.type === "error" && /* @__PURE__ */ jsx_runtime.jsxs(ThemedBox_default, {
        flexDirection: "column",
        gap: 1,
        children: [
          /* @__PURE__ */ jsx_runtime.jsxs(ThemedBox_default, {
...
var install = {
  ...
  async call(onDone, _context, args) {
    ...
    const { unmount } = await root_default(/* @__PURE__ */ jsx_runtime.jsx(Install, {
...
//# debugId=79F203A60956F6F264756E2164756E21
//# sourceMappingURL=chunk-85va80nr.js.map

...
function checkBridgeMinVersion() {
  if (true) {
    ...
    if (config.minVersion && lt("2.8.4", config.minVersion)) {
      return `Your version of Claude Code (${"2.8.4"}) is too old for Remote Control.
...
//# debugId=49C2020ADEE8A02E64756E2164756E21
//# sourceMappingURL=chunk-27zrv1td.js.map

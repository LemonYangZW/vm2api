...
function RemoteControlServer({ onDone }) {
  ...
  if (status === "running" && daemonProcess && !daemonProcess.killed) {
    return /* @__PURE__ */ jsx_runtime.jsx(ServerManagementDialog, {
      onDone
    });
  }
  ...
  return /* @__PURE__ */ jsx_runtime.jsx(Dialog, {
    ...
    children: /* @__PURE__ */ jsx_runtime.jsxs(ThemedBox_default, {
      ...
      children: [
        ...
        logPreview.length > 0 && /* @__PURE__ */ jsx_runtime.jsxs(ThemedBox_default, {
          flexDirection: "column",
          children: [
            /* @__PURE__ */ jsx_runtime.jsx(ThemedText, {
              dimColor: true,
            ...
            logPreview.map((line, i) => /* @__PURE__ */ jsx_runtime.jsx(ThemedText, {
              dimColor: true,
              children: line
            }, i))
          ]
...
async function call(onDone, _context, _args) {
  return /* @__PURE__ */ jsx_runtime.jsx(RemoteControlServer, {
    onDone
  });
}
var import_react, jsx_runtime, daemonProcess = null, daemonStatus = "stopped", daemonLogs, MAX_LOG_LINES = 50;
...
//# debugId=BD3F678E74C480EE64756E2164756E21
//# sourceMappingURL=chunk-nzfqjcg6.js.map

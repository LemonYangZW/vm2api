...
function TeleportProgress({ currentStep, sessionId }) {
  ...
  return /* @__PURE__ */ jsx_runtime.jsxs(ThemedBox_default, {
    ...
    children: [
      ...
      sessionId && /* @__PURE__ */ jsx_runtime.jsx(ThemedBox_default, {
        marginBottom: 1,
...
async function teleportWithProgress(root, sessionId) {
  ...
  function TeleportProgressWrapper() {
    ...
    setStep = _setStep;
    return /* @__PURE__ */ jsx_runtime.jsx(TeleportProgress, {
      currentStep: step,
      sessionId
    });
  }
  root.render(/* @__PURE__ */ jsx_runtime.jsx(AppStateProvider, {
    children: /* @__PURE__ */ jsx_runtime.jsx(TeleportProgressWrapper, {})
  }));
...
//# debugId=5178005B4C6672B364756E2164756E21
//# sourceMappingURL=chunk-ers5x6gd.js.map
